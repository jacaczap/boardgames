-- Change first available date in new survey to be 1 day after survey creation
-- (instead of 2 weeks after last meeting bumped to next Saturday).
-- Auto-create schedule (7 days after previous meeting) remains unchanged in the Edge Function.
